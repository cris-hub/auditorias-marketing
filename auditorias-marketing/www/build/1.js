...
var WelcomePage = (function () {
    ...
    WelcomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-welcome',template:/*ion-inline-start:"E:\projects\auditorias-marketing\src\pages\welcome\welcome.html"*/'<ion-content scroll="false">\n  <div class="splash-bg"></div>\n  <div class="splash-info">\n    <div class="splash-logo"></div>\n    <div class="splash-intro">\n      {{ \'WELCOME_INTRO\' | translate }}\n    </div>\n  </div>\n  <div padding>\n  <!-- BOTON DE REGISTRO DE USUARIOS  -->\n    <!-- <button ion-button block (click)="signup()">{{ \'SIGNUP\' | translate }}</button> -->\n    <!-- BOTON DE REGISTRO DE USUARIOS  -->\n    <button ion-button block (click)="login()" class="login">{{ \'LOGIN\' | translate }}</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"E:\projects\auditorias-marketing\src\pages\welcome\welcome.html"*/
        }),
